...
class TratamentosTable extends Table {
    ...
    public function validationDefault(Validator $validator) {
        ...
        $validator
                ->integer('contador_mensal')
                ->requirePresence('contador_mensal', 'create')
                ->allowEmptyString('contador_mensal', false);

        $validator
                ->scalar('tratament')
                ->maxLength('tratament', 255)
                ->requirePresence('tratament', 'create')
                ->allowEmptyString('tratament', false);
        ...
        $validator
                ->scalar('s_vacinacao')
                ->maxLength('s_vacinacao', 255)
                ->requirePresence('s_vacinacao', 'create')
                ->allowEmptyString('s_vacinacao', false);

        $validator
                ->scalar('obs')
                ->maxLength('obs', 255)
                ->requirePresence('obs', 'create')
                ->allowEmptyString('obs', false);
    ...
    //permite definir o relacionamento entre o tratameto e o utilizador responsavel
