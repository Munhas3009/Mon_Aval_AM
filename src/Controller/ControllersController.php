...
class ControllersController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Controllers->save($controller)) {
                $this->Flash->success(__('The {0} has been saved.', 'Controller'));

                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->error(__('The {0} could not be saved. Please, try again.', 'Controller'));
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Controllers->delete($controller)) {
            $this->Flash->success(__('The {0} has been deleted.', 'Controller'));
        } else {
            $this->Flash->error(__('The {0} could not be deleted. Please, try again.', 'Controller'));
        }
