                        ...
                        <tbody>
                            <?php foreach ($controllers as $controller): ?>
                                <tr>
                                    ...
                                    <td><?= h($controller->nickname) ?></td>
                                    <td class="actions text-center"><?= h($controller->created) ?></td>
                                    <td class="actions text-center"><?= h($controller->modified) ?></td>
                                    <td class="actions text-center">
                                        <?= $this->Html->link(__(''), ['action' => 'view', $controller->id], ['class' => 'btn btn-info btn-xs', 'class' => 'fa fa-eye']) ?>
                                        <?= $this->Html->link(__(''), ['action' => 'edit', $controller->id], ['class' => 'btn btn-warning btn-xs', 'class' => 'fa fa-edit']) ?>
                                        <?= $this->Form->postLink(__(''), ['action' => 'delete', $controller->id], ['confirm' => __('Are you sure you want to delete # {0}?', $controller->id)
