            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <dl class="dl-horizontal">
                        ...
                        <dd><?= $this->Number->format($action->id) ?></dd>

                        <dt scope="row"><?= __('Nome da Função') ?></dt>
                        <dd><?= h($action->name) ?></dd>
                        <dt scope="row"><?= __('Nickname') ?></dt>
                        <dd><?= h($action->nickname) ?></dd>

                        <dt scope="row"><?= __('Criado') ?></dt>
                        <dd><?= h($action->created) ?></dd>
                        <dt scope="row"><?= __('Actualizado') ?></dt>
                        <dd><?= h($action->modified) ?></dd>
                    </dl>
                </div>
            </div>
        </div>
                ...
                <div class="box-body">
                    <?php if (!empty($action->acos)): ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($action->acos as $acos): ?>
                                <tr>
                                    <td><?= h($acos->id) ?></td>
